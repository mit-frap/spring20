...
Module Type S.
  (* 10% for stating true and useful lemmas about empty trees *)
  (* 5% for proving lemmas about empty trees *)
  (* 20% for stating true and useful lemmas about non-empty trees *)
  (* 10% for proving lemmas about non-empty trees *)
